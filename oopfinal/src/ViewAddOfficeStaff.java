...
public class ViewAddOfficeStaff implements ActionListener {
    JFrame f1;
    JButton b1,b2,b3;
    JLabel l1;

    ViewAddOfficeStaff() {
        f1=new JFrame("OFFICE STAFF  ");
        b1=new JButton(" Add office Staff");
        b2=new JButton(" View office staff Detail");
        b3=new JButton("Back");
